...
const pathMap = {
  "full-stack-web-developer": {
    ...
    summary:
      "Build a complete product skill set from interface to database and deployment.",
    duration: "180 hours",
  ...
  "frontend-engineer": {
    ...
    summary:
      "Turn design and product thinking into polished, accessible interfaces.",
    duration: "120 hours",
  ...
  "backend-foundations": {
    ...
    summary:
      "Learn the server-side systems that support modern apps and services.",
    duration: "90 hours",
...
export default async function PublicPathDetailPage({
  params,
}: {
      ...
      <section className="mt-10 surface-panel p-6">
        ...
        <ul className="mt-5 space-y-3">
          {path.modules.map((module, index) => (
            ...
            >
              <span className="flex h-7 w-7 items-center justify-center rounded-full bg-[rgba(33,79,70,0.08)] text-xs font-semibold text-[var(--primary)]">
                {index + 1}
              </span>
