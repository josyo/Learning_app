    ...
    return (
      <div className="learner-copy">
        ...
        <p className="mt-3 text-base text-[rgba(34,38,31,0.72)]">
          You&apos;re not enrolled in a path yet — ask an admin to enroll you and your roadmap will
          appear here.
        </p>
      </div>
    );
  ...
  return (
    <div className="learner-copy">
      <header className="mb-8">
        <p className="font-mono text-sm text-[rgba(34,38,31,0.72)]">Learning path</p>
