...
> = {
  LOCKED: {
    label: "Locked",
    tone: "bg-[rgba(221,214,198,0.35)] text-[rgba(34,38,31,0.7)]",
    icon: Lock,
  },
  AVAILABLE: {
    label: "Available",
    tone: "bg-[rgba(62,86,65,0.12)] text-[var(--moss)]",
    icon: Check,
  },
  IN_PROGRESS: {
    label: "In progress",
    tone: "bg-[rgba(184,134,47,0.12)] text-[var(--ochre)]",
    icon: Clock3,
  },
  AWAITING_REVIEW: {
    label: "Awaiting review",
    tone: "bg-[rgba(34,38,31,0.06)] text-[var(--ink)]",
    icon: Clock3,
  },
  NEEDS_CHANGES: {
    label: "Needs changes",
    tone: "bg-[rgba(166,91,68,0.12)] text-[var(--clay-muted)]",
    icon: TriangleAlert,
  },
  COMPLETED: {
    label: "Completed",
  ...
  return (
    <ol className="flex flex-col gap-6">
      {modules.map((m, i) => {
        ...
        const row = (
          <div
            className="roadmap-step roadmap-animate"
